    ...
    <>
      <header className="fixed top-0 left-0 w-full z-50 bg-bg-base/90 backdrop-blur-sm px-4 md:px-12 py-6 flex justify-between items-center border-b border-ink/10">
        <div className="flex items-center gap-8 md:w-1/3">
          ...
          <nav className="hidden md:flex gap-10 text-[10px] font-bold tracking-[0.2em] font-mono">
        ...
        <div className="flex items-center justify-end gap-6 md:w-1/3">
          ...
          <div className="hidden md:flex flex-col items-end border-l border-ink/20 pl-6 h-10 justify-center">
            <p className="text-[9px] font-bold tracking-widest text-ink/40 font-mono">Since 1998</p>
          </div>
        </div>
      </header>
          ...
          <>
            ...
            >
              ...
              <nav className="flex flex-col p-6 gap-8">
                <Link to="/" className="text-2xl font-black tracking-tighter hover:pl-2 transition-all">Home</Link>
                <Link to="/shop" className="text-2xl font-black tracking-tighter hover:pl-2 transition-all">Shop</Link>
                <Link to="/collections" className="text-2xl font-black tracking-tighter hover:pl-2 transition-all">Collections</Link>
                <Link to="/brand-story" className="text-2xl font-black tracking-tighter hover:pl-2 transition-all">Brand Story</Link>
              </nav>
