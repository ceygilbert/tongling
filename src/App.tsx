...
import { ChevronLeft, ChevronRight, Instagram, Mail, ArrowRight, History, Users, Globe, Award, ShoppingBag, X, Plus, Minus } from "lucide-react";
...
const PRODUCTS: Product[] = [
  {
    ...
    lifestyleImage: "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?q=80&w=1000&auto=format&fit=crop",
    productImage: "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?q=80&w=1000&auto=format&fit=crop",
    price: 28.50,
  },
  {
    id: "2",
    ...
    lifestyleImage: "https://images.unsplash.com/photo-1595853035070-59a39fe84de3?q=80&w=1000&auto=format&fit=crop",
    productImage: "https://images.unsplash.com/photo-1584622781564-1d987f7333c1?q=80&w=1000&auto=format&fit=crop",
    price: 32.00,
  },
  {
    id: "3",
    ...
    lifestyleImage: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=1000&auto=format&fit=crop",
    productImage: "https://images.unsplash.com/photo-1618220179428-22790b461013?q=80&w=1000&auto=format&fit=crop",
    price: 45.00,
  },
  {
    id: "4",
    ...
    technique: "PLAIN WEAVE",
    status: "ECO-FRIENDLY",
    lifestyleImage: "https://images.unsplash.com/photo-1518131148949-020cf3d7948f?q=80&w=1000&auto=format&fit=crop",
    productImage: "https://images.unsplash.com/photo-1562582664-8a8803c031ca?q=80&w=1000&auto=format&fit=crop",
    price: 24.50,
  },
  {
    id: "5",
    ...
    lifestyleImage: "https://images.unsplash.com/photo-1544441893-675973e31985?q=80&w=1000&auto=format&fit=crop",
    productImage: "https://images.unsplash.com/photo-1554188248-986adbb73be4?q=80&w=1000&auto=format&fit=crop",
    price: 35.00,
  },
  {
    id: "6",
    ...
    status: "INNOVATION",
    lifestyleImage: "https://images.unsplash.com/photo-1513519245088-0e12902e35ca?q=80&w=1000&auto=format&fit=crop",
    productImage: "https://images.unsplash.com/photo-1584622781514-f6342191675a?q=80&w=1000&auto=format&fit=crop",
    price: 38.00,
  },
  {
    id: "7",
    ...
    lifestyleImage: "https://images.unsplash.com/photo-1551298370-9d3d53e40c81?q=80&w=1000&auto=format&fit=crop",
    productImage: "https://images.unsplash.com/photo-1528459801416-a9e53bbf4e17?q=80&w=1000&auto=format&fit=crop",
    price: 42.00,
  },
];
...
const Header: React.FC<{ cartCount: number; onOpenCart: () => void }> = ({ cartCount, onOpenCart }) => (
  <header className="fixed top-0 left-0 w-full z-50 bg-white/80 backdrop-blur-sm px-6 py-4 flex justify-between items-center border-b border-gray-100">
    <nav className="flex gap-6 text-[11px] font-bold tracking-tighter uppercase">
    ...
    <div className="absolute left-1/2 -translate-x-1/2">
      <Link to="/">
        <img src={LOGO_URL} alt="Tongling Sincerity Logo" className="h-12 w-auto object-contain" referrerPolicy="no-referrer" />
      </Link>
    </div>
...
const Hero: React.FC = () => (
  <section className="pt-32 px-6 mb-24">
    <motion.div 
      ...
      className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[70vh]"
    >
      ...
      <div className="relative overflow-hidden group">
        <img 
          src="https://images.unsplash.com/photo-1595853035070-59a39fe84de3?q=80&w=1000&auto=format&fit=crop" 
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/10">
          ...
          >
            <h2 className="text-3xl font-black text-white tracking-tighter uppercase leading-none">TONGLING</h2>
            <p className="text-[10px] font-bold text-white tracking-[0.3em] uppercase mt-2">Sincerity Linen</p>
          </motion.div>
        </div>
      </div>
      <div className="relative overflow-hidden group">
    ...
    >
      <h3 className="text-2xl font-bold tracking-tighter mb-4 uppercase">'THE ART OF SINCERITY'</h3>
    ...
    <section className="px-6 mb-32 overflow-hidden">
      <div className="relative min-h-[80vh] flex items-center">
          ...
          >
            ...
            <div className="lg:col-span-3">
              <motion.div 
                ...
                className="aspect-[3/4] bg-white flex items-center justify-center p-8 border border-gray-100"
              >
                <img 
            ...
            <div className="lg:col-span-4 flex flex-col gap-8">
              <motion.div 
                ...
                className="max-w-md"
              >
                <h4 className="text-3xl font-bold tracking-tighter mb-6 uppercase">'{product.title}'</h4>
                <p className="font-mono text-[13px] leading-relaxed mb-8 text-gray-600">
                  {product.description}
                </p>
                
                <div className="font-mono text-[14px] font-bold uppercase tracking-tighter space-y-2 border-l-2 border-black pl-4">
                ...
                <div className="mt-12 flex items-center gap-4">
                  <span className="font-mono text-[16px] font-bold uppercase tracking-tighter bg-black text-white px-4 py-2">
                    {product.status}
                  </span>
                  <button className="flex items-center gap-2 font-bold text-[12px] uppercase tracking-widest hover:gap-4 transition-all">
        ...
        <div className="absolute bottom-0 right-0 flex gap-4 z-20">
          <button 
            onClick={prevSlide}
            className="p-4 bg-white border border-black hover:bg-black hover:text-white transition-colors"
          >
            <ChevronLeft size={24} />
          </button>
          <button 
        ...
        {/* Slide Counter */}
        <div className="absolute top-0 right-0 font-mono text-[12px] font-bold">
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-32">
        ...
        >
          ...
          <p className="font-mono text-[14px] leading-relaxed uppercase tracking-tight text-gray-600 mb-8">
        ...
        >
          ...
          <h3 className="text-2xl font-bold tracking-tighter uppercase mb-4">A SENSITIVITY OF TOUCH</h3>
          <p className="font-mono text-[12px] leading-relaxed uppercase tracking-tight text-gray-500">
      ...
      <section className="mb-32">
        <div className="flex justify-between items-end mb-8 border-b border-black pb-4">
          <h2 className="text-4xl font-black tracking-tighter uppercase">THE CUSTODIANS</h2>
          <p className="font-mono text-[10px] uppercase tracking-widest text-gray-400">GENERATIONS OF SINCERITY</p>
        </div>
        ...
        <div className="relative group overflow-hidden mb-12">
          <motion.div
            ...
            className="aspect-[21/9] bg-gray-100"
          >
            <img 
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 flex items-end p-8">
            <p className="text-white font-mono text-[10px] uppercase tracking-[0.2em]">Our Sales & Production Team — Shanghai, 2025</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-8">
            <p className="font-mono text-[16px] leading-relaxed uppercase tracking-tight text-gray-800">
          ...
          <div className="md:col-span-4 flex flex-col justify-end">
            <div className="border-l-2 border-black pl-6">
              <p className="font-bold text-[11px] uppercase tracking-widest mb-2">COLLECTIVE EXPERIENCE</p>
              <p className="text-4xl font-black tracking-tighter uppercase">120+ YEARS</p>
            </div>
          </div>
        </div>
      </section>

      <div className="border-t border-gray-100 pt-24 mb-32">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="flex flex-col gap-4">
            <History className="text-gray-300" size={40} strokeWidth={1} />
            <h4 className="font-bold text-xl tracking-tighter">30+ YEARS</h4>
            <p className="font-mono text-[10px] uppercase text-gray-500">Specializing in linen and linen-blend fabric production for over three decades.</p>
          </div>
          <div className="flex flex-col gap-4">
            <Users className="text-gray-300" size={40} strokeWidth={1} />
            <h4 className="font-bold text-xl tracking-tighter">OUR TEAM</h4>
            <p className="font-mono text-[10px] uppercase text-gray-500">Aunt Sun (33y), Aunt Cui (28y), Uncle Lu (28y) — generations of craft.</p>
          </div>
          <div className="flex flex-col gap-4">
            <Globe className="text-gray-300" size={40} strokeWidth={1} />
            <h4 className="font-bold text-xl tracking-tighter">GLOBAL REACH</h4>
            <p className="font-mono text-[10px] uppercase text-gray-500">Providing efficient, eco-friendly solutions to leading clothing brands worldwide.</p>
          </div>
          <div className="flex flex-col gap-4">
            <Award className="text-gray-300" size={40} strokeWidth={1} />
            <h4 className="font-bold text-xl tracking-tighter">TRUSTED</h4>
            <p className="font-mono text-[10px] uppercase text-gray-500">Nearly ten brands partnering with us for over 15 years.</p>
          </div>
        </div>
      </div>

      <div className="text-center max-w-3xl mx-auto mb-32">
        <h2 className="text-4xl font-black tracking-tighter uppercase mb-8">ONE THREAD AT A TIME</h2>
        <p className="font-mono text-[14px] leading-relaxed uppercase tracking-tight">
    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-end">
      ...
      <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-8">
        <div className="flex flex-col gap-2">
          <h5 className="font-mono text-[10px] font-bold uppercase tracking-tighter text-gray-400">SUPPORT</h5>
          <nav className="flex flex-col gap-1 font-mono text-[11px] uppercase tracking-tighter">
        ...
        <div className="flex flex-col gap-2">
          <h5 className="font-mono text-[10px] font-bold uppercase tracking-tighter text-gray-400">COMPANY</h5>
          <nav className="flex flex-col gap-1 font-mono text-[11px] uppercase tracking-tighter">
        ...
        <div className="flex flex-col gap-2">
          <h5 className="font-mono text-[10px] font-bold uppercase tracking-tighter text-gray-400">SUBSCRIBE TO</h5>
          <nav className="flex flex-col gap-1 font-mono text-[11px] uppercase tracking-tighter">
  ...
  <div className="pt-32 pb-24 px-6">
    ...
    >
      <div className="text-center mb-24">
        <h2 className="text-6xl font-black tracking-tighter uppercase mb-6">COLLECTIONS</h2>
        <p className="font-mono text-[12px] uppercase tracking-[0.3em] text-gray-400">Sustainable • Natural • Sincere</p>
      </div>

      {/* Apparel Fabrics Section */}
      <section className="mb-32">
        <div className="flex items-center gap-4 mb-12">
          <h3 className="text-3xl font-bold tracking-tighter uppercase">APPAREL FABRICS</h3>
          <div className="h-[1px] flex-grow bg-gray-100" />
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { title: "PIECE DYED", desc: "Woven first, dyed later. Offering maximum flexibility in color selection and quick response to fashion trends.", img: "https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?q=80&w=800" },
            { title: "YARN DYED", desc: "Dyeing yarns before weaving for rich, long-lasting colors and intricate patterns like stripes and chambrays.", img: "https://images.unsplash.com/photo-1544441893-675973e31985?q=80&w=800" },
            { title: "PRINTED", desc: "Versatile designs from screen to high-resolution digital printing with minimal environmental impact.", img: "https://images.unsplash.com/photo-1551298370-9d3d53e40c81?q=80&w=800" },
            { title: "SPECIAL FINISHES", desc: "Dobby, Embroidery, Jacquard, and Functional finishes like Anti-Wrinkle and Anti-UV.", img: "https://images.unsplash.com/photo-1513519245088-0e12902e35ca?q=80&w=800" }
          ].map((item, i) => (
            <motion.div 
              key={item.title}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <h4 className="font-bold text-[14px] uppercase tracking-tighter mb-2">{item.title}</h4>
              <p className="font-mono text-[10px] uppercase text-gray-500 leading-relaxed">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-32">
        <div className="flex items-center gap-4 mb-12">
          <div className="h-[1px] flex-grow bg-gray-100" />
          <h3 className="text-3xl font-bold tracking-tighter uppercase">HOME TEXTILES</h3>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5">
            <h4 className="text-2xl font-bold tracking-tighter uppercase mb-6">BRING NATURE HOME</h4>
            <p className="font-mono text-[12px] leading-relaxed uppercase tracking-tight text-gray-600 mb-8">
            ...
            <div className="grid grid-cols-2 gap-4 font-mono text-[10px] uppercase font-bold">
              <div className="border-l-2 border-black pl-4 py-2">BEDDING & CURTAINS</div>
              <div className="border-l-2 border-black pl-4 py-2">TABLE & KITCHEN</div>
              <div className="border-l-2 border-black pl-4 py-2">BATH & DECOR</div>
              <div className="border-l-2 border-black pl-4 py-2">CUSTOM STORAGE</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-32 bg-black text-white p-12 lg:p-24">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-4xl font-black tracking-tighter uppercase mb-12">MATERIAL INNOVATION</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
            <div>
              <h4 className="font-bold text-[14px] uppercase tracking-widest mb-6 border-b border-white/20 pb-2">CORE COMPOSITIONS</h4>
              <ul className="font-mono text-[11px] uppercase space-y-3 text-gray-400">
            ...
            <div>
              <h4 className="font-bold text-[14px] uppercase tracking-widest mb-6 border-b border-white/20 pb-2">NATURAL FIBERS</h4>
              <ul className="font-mono text-[11px] uppercase space-y-3 text-gray-400">
                <li>• Ramie Fabric</li>
                <li>• Hemp Fabric</li>
                <li>• Organic Linen</li>
    ...
    <div className="pt-32 pb-24 px-6">
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div>
            <h2 className="text-6xl font-black tracking-tighter uppercase mb-2">SHOP</h2>
            <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-gray-400">Premium Linen Textiles by the Yard</p>
          </div>
          <div className="flex flex-wrap gap-4">
            {categories.map(cat => (
              <button
                ...
                className={`font-mono text-[9px] uppercase tracking-widest px-4 py-2 border transition-all duration-300 ${
            ...
            >
              <div className="relative aspect-[3/4] bg-gray-50 overflow-hidden mb-6">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-white px-2 py-1 font-mono text-[8px] uppercase tracking-widest font-bold border border-gray-100">
                    {product.status}
                  </span>
                </div>
                <button 
                  onClick={() => onAddToCart(product)}
                  className="absolute bottom-0 left-0 w-full bg-black text-white py-4 font-bold text-[10px] uppercase tracking-[0.2em] translate-y-full group-hover:translate-y-0 transition-transform duration-500"
                >
              ...
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="font-bold text-[14px] uppercase tracking-tighter mb-1">{product.title}</h3>
                  <p className="font-mono text-[10px] text-gray-400 uppercase tracking-tight">{product.material}</p>
                </div>
                <p className="font-mono text-[12px] font-black tracking-tighter">${product.price.toFixed(2)}</p>
              </div>
            </motion.div>
          ))}
        </div>
